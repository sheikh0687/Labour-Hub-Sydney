...
class PreClientInvoiceNameVC: UIViewController {
                ...
                do {
                    ...
                    if let CategoryListStatus = root.status {
                        if CategoryListStatus == "1" {
                            ...
                            self.tableViewHeight.constant = CGFloat(self.arrCLientList.count * 45)
...
extension PreClientInvoiceNameVC: UITableViewDataSource {
...
extension PreClientInvoiceNameVC: UITableViewDelegate {
