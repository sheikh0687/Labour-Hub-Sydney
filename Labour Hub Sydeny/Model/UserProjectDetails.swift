...
struct GetUserProjectDetails : Codable {
    let result : ResUserProjectDetails?
    let message : String?
    let status : String?
    ...
    init(from decoder: Decoder) throws {
        ...
        result = try values.decodeIfPresent(ResUserProjectDetails.self, forKey: .result)
        message = try values.decodeIfPresent(String.self, forKey: .message)
        status = try values.decodeIfPresent(String.self, forKey: .status)
    }
}

struct ResUserProjectDetails : Codable {
    let id : String?
    let user_id : String?
    let title : String?
    ...
    let user_details : UserProjectdetails?
    let user_request_images : [User_request_images]?
    ...
    init(from decoder: Decoder) throws {
        ...
        user_details = try values.decodeIfPresent(UserProjectdetails.self, forKey: .user_details)
        user_request_images = try values.decodeIfPresent([User_request_images].self, forKey: .user_request_images)
        service_list = try values.decodeIfPresent([Service_list].self, forKey: .service_list)
    }
}

struct UserProjectdetails : Codable {
    let id : String?
    let store_id : String?
...
struct User_request_images : Codable {
    let id : String?
...
struct Service_list : Codable {
    ...
    let status : String?
    let date_time : String?
    let assign_employee : [Assign_employee]?
    ...
    init(from decoder: Decoder) throws {
        ...
        status = try values.decodeIfPresent(String.self, forKey: .status)
        date_time = try values.decodeIfPresent(String.self, forKey: .date_time)
        assign_employee = try values.decodeIfPresent([Assign_employee].self, forKey: .assign_employee)
    }

}
struct Assign_employee : Codable {
    let id : String?
    let store_id : String?
    let first_name : String?
    let last_name : String?
