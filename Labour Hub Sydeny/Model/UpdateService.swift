...
struct getUpdatedService : Codable {
    let result : ResUpdateService?
    let message : String?
    let status : String?
    ...
    init(from decoder: Decoder) throws {
        ...
        result = try values.decodeIfPresent(ResUpdateService.self, forKey: .result)
...
struct ResUpdateService : Codable {
    let id : String?
