...
struct GetClientAllProjects : Codable {
    let result : [ResAllClientProject]?
    let message : String?
    let status : String?
    ...
    init(from decoder: Decoder) throws {
        ...
        result = try values.decodeIfPresent([ResAllClientProject].self, forKey: .result)
...
struct ResAllClientProject : Codable {
    let id : String?
    ...
    let project_details : All_Client_Project_details?
    let service_list : All_Client_Service_list?
    ...
    init(from decoder: Decoder) throws {
        ...
        project_details = try values.decodeIfPresent(All_Client_Project_details.self, forKey: .project_details)
        service_list = try values.decodeIfPresent(All_Client_Service_list.self, forKey: .service_list)
    }

}

struct All_Client_Project_details : Codable {
    let id : String?
    let user_id : String?
    let title : String?
...
struct All_Client_Service_list : Codable {
    let id : String?
    let request_id : String?
    let cat_id : String?
    let cat_name : String?
