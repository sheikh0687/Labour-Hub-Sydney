...
struct GetNewInvoiceAllDetials : Codable {
    let result : [ResNewInvoice]?
    let message : String?
    let status : String?
    ...
    init(from decoder: Decoder) throws {
        ...
        result = try values.decodeIfPresent([ResNewInvoice].self, forKey: .result)
        message = try values.decodeIfPresent(String.self, forKey: .message)
        status = try values.decodeIfPresent(String.self, forKey: .status)
    }
}

struct ResNewInvoice : Codable {
    let id : String?
    let user_id : String?
    let title : String?
    ...
    let service_list : [New_Invoice_Service_list]?
    ...
    init(from decoder: Decoder) throws {
        ...
        service_list = try values.decodeIfPresent([New_Invoice_Service_list].self, forKey: .service_list)
...
struct New_Invoice_Service_list : Codable {
    let id : String?
