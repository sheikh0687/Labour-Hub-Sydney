...
struct GetCLientProject : Codable {
    ...
    init(from decoder: Decoder) throws {
        ...
        result = try values.decodeIfPresent([ResClientProject].self, forKey: .result)
...
struct ResClientProject : Codable {
    let id : String?
    ...
    let project_details : Client_Project_details?
    let service_list : Client_Service_list?
    ...
    init(from decoder: Decoder) throws {
        ...
        project_details = try values.decodeIfPresent(Client_Project_details.self, forKey: .project_details)
        service_list = try values.decodeIfPresent(Client_Service_list.self, forKey: .service_list)
    }

}

struct Client_Project_details : Codable {
    let id : String?
    let user_id : String?
    let title : String?
...
struct Client_Service_list : Codable {
    let id : String?
    let request_id : String?
    let cat_id : String?
    let cat_name : String?
