...
struct UpdateProfiles : Codable {
    let result : ResUpdateEmplyeProfile?
    let message : String?
    let status : String?
    ...
    init(from decoder: Decoder) throws {
        ...
        result = try values.decodeIfPresent(ResUpdateEmplyeProfile.self, forKey: .result)
...
struct ResUpdateEmplyeProfile : Codable {
    let id : String?
    let store_id : String?
