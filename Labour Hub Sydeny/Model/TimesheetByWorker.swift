...
struct GetTimesheetByWOrker : Codable {
    let result : [ResWorkerTimesheet]?
    let message : String?
    let status : String?
    ...
    init(from decoder: Decoder) throws {
        ...
        result = try values.decodeIfPresent([ResWorkerTimesheet].self, forKey: .result)
        message = try values.decodeIfPresent(String.self, forKey: .message)
        status = try values.decodeIfPresent(String.self, forKey: .status)
    }
}

struct ResWorkerTimesheet : Codable {
    let id : String?
    ...
    let project_details : Company_Timesheet_Project_details?
    let worker_details : Company_Timesheet_Worker_details?
    let client_details : Company_Timesheet_Client_details?
    ...
    init(from decoder: Decoder) throws {
        ...
        project_details = try values.decodeIfPresent(Company_Timesheet_Project_details.self, forKey: .project_details)
        worker_details = try values.decodeIfPresent(Company_Timesheet_Worker_details.self, forKey: .worker_details)
        client_details = try values.decodeIfPresent(Company_Timesheet_Client_details.self, forKey: .client_details)
    }
}

struct Company_Timesheet_Worker_details : Codable {
    let id : String?
    let store_id : String?
...
struct Company_Timesheet_Project_details : Codable {
    let id : String?
    let user_id : String?
    let title : String?
    let company_code : String?
...
struct Company_Timesheet_Client_details : Codable {
    let id : String?
    let store_id : String?
    let first_name : String?
    let last_name : String?
