...
struct GetUserProject : Codable {
    let result : [ResUserProject]?
    let message : String?
    let status : String?
    ...
    init(from decoder: Decoder) throws {
        ...
        result = try values.decodeIfPresent([ResUserProject].self, forKey: .result)
        message = try values.decodeIfPresent(String.self, forKey: .message)
        status = try values.decodeIfPresent(String.self, forKey: .status)
    }
}

struct ResUserProject : Codable {
    let id : String?
    let user_id : String?
    let title : String?
    ...
    let user_request_images : [User_request_images_Dt]?
    let service_list : [UserService_list]?
    ...
    init(from decoder: Decoder) throws {
        ...
        user_request_images = try values.decodeIfPresent([User_request_images_Dt].self, forKey: .user_request_images)
        service_list = try values.decodeIfPresent([UserService_list].self, forKey: .service_list)
    }
}
...
struct UserService_list : Codable {
    let id : String?
...
struct User_request_images_Dt : Codable {
    let id : String?
    let request_id : String?
    let image : String?
    let date_time : String?
