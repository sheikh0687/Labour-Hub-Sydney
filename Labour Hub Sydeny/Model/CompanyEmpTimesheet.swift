...
struct CompanyEmpTimesheet : Codable {
    let result : [ResCompanyEmpTimesheet]?
    let message : String?
    let status : String?
    ...
    init(from decoder: Decoder) throws {
        ...
        result = try values.decodeIfPresent([ResCompanyEmpTimesheet].self, forKey: .result)
        message = try values.decodeIfPresent(String.self, forKey: .message)
        status = try values.decodeIfPresent(String.self, forKey: .status)
    }
}

struct ResCompanyEmpTimesheet : Codable {
    let id : String?
    let user_id : String?
    let title : String?
    ...
    let worker_details : [Company_Worker_details]?
    let user_details : Comany_Employe_details?
    ...
    init(from decoder: Decoder) throws {
        ...
        worker_details = try values.decodeIfPresent([Company_Worker_details].self, forKey: .worker_details)
        user_details = try values.decodeIfPresent(Comany_Employe_details.self, forKey: .user_details)
    }

}

struct Company_Worker_details : Codable {
    let id : String?
    let store_id : String?
    ...
    let discount : String?
    let gST : String?
    let time_sheet : [Company_Time_sheet]?
    let work_hour : Int?
    let overtime_hour : Int?
    let total_hour : Int?
    ...
    enum CodingKeys: String, CodingKey {
        ...
        case discount = "discount"
        case gST = "GST"
        case time_sheet = "time_sheet"
        case work_hour = "work_hour"
        case overtime_hour = "overtime_hour"
    ...
    init(from decoder: Decoder) throws {
        ...
        time_sheet = try values.decodeIfPresent([Company_Time_sheet].self, forKey: .time_sheet)
        work_hour = try values.decodeIfPresent(Int.self, forKey: .work_hour)
        overtime_hour = try values.decodeIfPresent(Int.self, forKey: .overtime_hour)
        total_hour = try values.decodeIfPresent(Int.self, forKey: .total_hour)
    }

}

struct Company_Time_sheet : Codable {
    let id : String?
...
struct Comany_Employe_details : Codable {
    let id : String?
    let store_id : String?
    let first_name : String?
    let last_name : String?
