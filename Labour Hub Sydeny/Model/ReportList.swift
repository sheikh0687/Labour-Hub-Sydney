...
struct GetCompanyReportList : Codable {
    let result : [ResCompanyReportList]?
    let message : String?
    let status : String?
    ...
    init(from decoder: Decoder) throws {
        ...
        result = try values.decodeIfPresent([ResCompanyReportList].self, forKey: .result)
        message = try values.decodeIfPresent(String.self, forKey: .message)
        status = try values.decodeIfPresent(String.self, forKey: .status)
    }
}

struct ResCompanyReportList : Codable {
    let id : String?
    let user_id : String?
    let title : String?
    ...
    let worker_details : [Worker_details_Report]?
    let user_details : Report_details?
    ...
    init(from decoder: Decoder) throws {
        ...
        worker_details = try values.decodeIfPresent([Worker_details_Report].self, forKey: .worker_details)
        user_details = try values.decodeIfPresent(Report_details.self, forKey: .user_details)
    }
}

struct Report_details : Codable {
    let id : String?
    let store_id : String?
...
struct Worker_details_Report : Codable {
    let id : String?
    let store_id : String?
    let first_name : String?
    let last_name : String?
    ...
    init(from decoder: Decoder) throws {
        ...
        discount = try values.decodeIfPresent(String.self, forKey: .discount)
        gST = try values.decodeIfPresent(String.self, forKey: .gST)
        time_sheet = try values.decodeIfPresent([Time_sheet].self, forKey: .time_sheet)
