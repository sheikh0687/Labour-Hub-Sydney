...
struct GetDetailsRequestedInvoice : Codable {
    let result : ResRequestedDetailInvoice?
    let message : String?
    let status : String?
    ...
    init(from decoder: Decoder) throws {
        ...
        result = try values.decodeIfPresent(ResRequestedDetailInvoice.self, forKey: .result)
        message = try values.decodeIfPresent(String.self, forKey: .message)
        status = try values.decodeIfPresent(String.self, forKey: .status)
    }
}

struct ResRequestedDetailInvoice : Codable {
    let id : String?
    let user_id : String?
    ...
    let service_lis : [Requested_Details_Service_lis]?
    ...
    init(from decoder: Decoder) throws {
        ...
        service_lis = try values.decodeIfPresent([Requested_Details_Service_lis].self, forKey: .service_lis)
    }

}

struct Requested_Details_Service_lis : Codable {
    let id : String?
