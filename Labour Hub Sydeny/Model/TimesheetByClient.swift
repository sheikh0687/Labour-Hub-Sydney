...
struct GetCLientTimesheet : Codable {
    let result : [ResClientTimesheet]?
    let message : String?
    let status : String?
    ...
    init(from decoder: Decoder) throws {
        ...
        result = try values.decodeIfPresent([ResClientTimesheet].self, forKey: .result)
        message = try values.decodeIfPresent(String.self, forKey: .message)
        status = try values.decodeIfPresent(String.self, forKey: .status)
    }
}

struct ResClientTimesheet : Codable {
    let id : String?
    ...
    let project_details : Client_All_Project_details?
    let worker_details : Client_Timesheet_details?
    let client_details : Client_All_Timesheet_details?
    ...
    init(from decoder: Decoder) throws {
        ...
        project_details = try values.decodeIfPresent(Client_All_Project_details.self, forKey: .project_details)
        worker_details = try values.decodeIfPresent(Client_Timesheet_details.self, forKey: .worker_details)
        client_details = try values.decodeIfPresent(Client_All_Timesheet_details.self, forKey: .client_details)
    }

}

struct Client_Timesheet_details : Codable {
    let id : String?
    let store_id : String?
...
struct Client_All_Timesheet_details : Codable {
    let id : String?
    let store_id : String?
    let first_name : String?
    let last_name : String?
...
struct Client_All_Project_details : Codable {
    let id : String?
    let user_id : String?
    let title : String?
    let company_code : String?
