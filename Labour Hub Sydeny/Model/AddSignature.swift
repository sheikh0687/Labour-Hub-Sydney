...
//  Labour Hub Sydeny
//
//  Created by Techimmense Software Solutions on 03/07/23.
//

import Foundation

struct AddE_Signature : Codable {
    
    let result : Res_E_Signature?
    let message : String?
    let status : String?
    ...
    init(from decoder: Decoder) throws {
        ...
        result = try values.decodeIfPresent(Res_E_Signature.self, forKey: .result)
...
struct Res_E_Signature : Codable {
    let id : String?
