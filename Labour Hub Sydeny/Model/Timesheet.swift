...
struct GetTimesheetDetails : Codable {
    let result : [ResTimesheetDt]?
    let message : String?
    let status : String?
    ...
    init(from decoder: Decoder) throws {
        ...
        result = try values.decodeIfPresent([ResTimesheetDt].self, forKey: .result)
