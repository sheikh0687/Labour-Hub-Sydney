...
struct GetClientProjectInvoice : Codable {
    let result : ResClientProjectInvoice?
    let message : String?
    let status : String?
    ...
    init(from decoder: Decoder) throws {
        ...
        result = try values.decodeIfPresent(ResClientProjectInvoice.self, forKey: .result)
        message = try values.decodeIfPresent(String.self, forKey: .message)
        status = try values.decodeIfPresent(String.self, forKey: .status)
    }
}

struct ResClientProjectInvoice : Codable {
    let id : String?
    let user_id : String?
    let title : String?
    ...
    let service_list : [Client_Project_Invoice_Service]?
    let f_sub_total_amount : String?
    let f_total_amount : String?
    let f_gst_total_amount : String?
    ...
    enum CodingKeys: String, CodingKey {
        ...
        case f_sub_total_amount = "f_sub_total_amount"
        case f_total_amount = "f_total_amount"
        case f_gst_total_amount = "f_gst_total_amount"
    }
    ...
    init(from decoder: Decoder) throws {
        ...
        service_list = try values.decodeIfPresent([Client_Project_Invoice_Service].self, forKey: .service_list)
        f_sub_total_amount = try values.decodeIfPresent(String.self, forKey: .f_sub_total_amount)
        f_total_amount = try values.decodeIfPresent(String.self, forKey: .f_total_amount)
        f_gst_total_amount = try values.decodeIfPresent(String.self, forKey: .f_gst_total_amount)
    }

}

struct Client_Project_Invoice_Service : Codable {
    let id : String?
    ...
    enum CodingKeys: String, CodingKey {
        ...
        case status = "status"
        case date_time = "date_time"
        case total_work_hour = "total_work_hour"
        ...
        case gST = "GST"
        case discount = "discount"
        case fianl_pay_amount = "fianl_pay_amount"
    ...
    init(from decoder: Decoder) throws {
        ...
        status = try values.decodeIfPresent(String.self, forKey: .status)
        date_time = try values.decodeIfPresent(String.self, forKey: .date_time)
        total_work_hour = try values.decodeIfPresent(String.self, forKey: .total_work_hour)
        ...
        discount = try values.decodeIfPresent(String.self, forKey: .discount)
        fianl_pay_amount = try values.decodeIfPresent(String.self, forKey: .fianl_pay_amount)
