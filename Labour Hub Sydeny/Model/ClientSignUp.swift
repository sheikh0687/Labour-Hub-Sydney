...
struct GetClientSignUp : Codable {
    let result : ResClientSignUp?
    let message : String?
    let status : String?
    ...
    init(from decoder: Decoder) throws {
        ...
        result = try values.decodeIfPresent(ResClientSignUp.self, forKey: .result)
...
struct ResClientSignUp : Codable {
    let id : String?
    let store_id : String?
