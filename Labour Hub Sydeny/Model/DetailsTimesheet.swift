//
//  DetailsTimesheet.swift
//  Labour Hub Sydeny
//
//  Created by Techimmense Software Solutions on 13/07/23.
//

import Foundation

struct ApiDetailTimesheet : Codable {
    let result : ResDetailTimesheet?
    let message : String?
    let status : String?
    ...
    init(from decoder: Decoder) throws {
        ...
        result = try values.decodeIfPresent(ResDetailTimesheet.self, forKey: .result)
        message = try values.decodeIfPresent(String.self, forKey: .message)
        status = try values.decodeIfPresent(String.self, forKey: .status)
    }
}

struct ResDetailTimesheet : Codable {
    let id : String?
    ...
    let project_details : TimesheetProjectDt?
    let worker_details : TimesheetWorkerDt?
    let client_details : TimesheetClientDt?
    ...
    init(from decoder: Decoder) throws {
        ...
        project_details = try values.decodeIfPresent(TimesheetProjectDt.self, forKey: .project_details)
        worker_details = try values.decodeIfPresent(TimesheetWorkerDt.self, forKey: .worker_details)
        client_details = try values.decodeIfPresent(TimesheetClientDt.self, forKey: .client_details)
    }
}

struct TimesheetProjectDt : Codable {
    let id : String?
    let user_id : String?
    let title : String?
...
struct TimesheetWorkerDt : Codable {
    let id : String?
    let store_id : String?
...
struct TimesheetClientDt : Codable {
    let id : String?
    let store_id : String?
    let first_name : String?
    let last_name : String?
