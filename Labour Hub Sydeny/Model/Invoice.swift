...
struct GetProjectInvoice : Codable {
    let result : ResProjectInvoice?
    let message : String?
    let status : String?
    ...
    init(from decoder: Decoder) throws {
        ...
        result = try values.decodeIfPresent(ResProjectInvoice.self, forKey: .result)
...
struct ResProjectInvoice : Codable {
    let id : String?
    let user_id : String?
    let title : String?
    ...
    let service_list : [Invoice_Service_list]?
    ...
    init(from decoder: Decoder) throws {
        ...
        service_list = try values.decodeIfPresent([Invoice_Service_list].self, forKey: .service_list)
...
struct Invoice_Service_list : Codable {
    let id : String?
