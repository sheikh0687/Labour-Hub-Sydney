...
struct SelectEmployeStatus : Codable {
    let result : [ResCompanyStatus]?
    let status : String?
    let message : String?
    ...
    init(from decoder: Decoder) throws {
        ...
        result = try values.decodeIfPresent([ResCompanyStatus].self, forKey: .result)
...
struct ResCompanyStatus : Codable {
    let id : String?
    let store_id : String?
