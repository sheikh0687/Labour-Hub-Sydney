...
struct GetEmpTimesheetDetail : Codable {
    let result : [ResEmpTimesheetDt]?
    let message : String?
    let status : String?
    ...
    init(from decoder: Decoder) throws {
        ...
        result = try values.decodeIfPresent([ResEmpTimesheetDt].self, forKey: .result)
        message = try values.decodeIfPresent(String.self, forKey: .message)
        status = try values.decodeIfPresent(String.self, forKey: .status)
    }
}

struct ResEmpTimesheetDt : Codable {
    let id : String?
    ...
    let worker_details : Worker_details_Timesheet?
    let client_details : Employe_Timesheet_details?
    ...
    init(from decoder: Decoder) throws {
        ...
        project_details = try values.decodeIfPresent(Project_details.self, forKey: .project_details)
        worker_details = try values.decodeIfPresent(Worker_details_Timesheet.self, forKey: .worker_details)
        client_details = try values.decodeIfPresent(Employe_Timesheet_details.self, forKey: .client_details)
    }
}

struct Employe_Timesheet_details : Codable {
    let id : String?
    let store_id : String?
...
struct Worker_details_Timesheet : Codable {
    let id : String?
    let store_id : String?
    let first_name : String?
    let last_name : String?
...
struct Timesheet_Project_details : Codable {
    let id : String?
    let user_id : String?
    let title : String?
    let company_code : String?
