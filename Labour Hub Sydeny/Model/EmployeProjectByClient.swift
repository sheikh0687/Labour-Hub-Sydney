...
struct GetEmpProjectByClient : Codable {
    let result : [ResClientProjectList]?
    let message : String?
    let status : String?
    ...
    init(from decoder: Decoder) throws {
        ...
        result = try values.decodeIfPresent([ResClientProjectList].self, forKey: .result)
...
struct ResClientProjectList : Codable {
    let id : String?
    ...
    let project_details : Project_details_List?
    let service_list : Client_Project_list_Dt?
    ...
    init(from decoder: Decoder) throws {
        ...
        project_details = try values.decodeIfPresent(Project_details_List.self, forKey: .project_details)
        service_list = try values.decodeIfPresent(Client_Project_list_Dt.self, forKey: .service_list)
    }

}

struct Project_details_List : Codable {
    let id : String?
    let user_id : String?
    let title : String?
...
struct Client_Project_list_Dt : Codable {
    let id : String?
    let request_id : String?
    let cat_id : String?
    let cat_name : String?
