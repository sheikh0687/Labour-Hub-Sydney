...
struct GetCompanyProjectDetails : Codable {
    let result : ResCompProjectDt?
    let message : String?
    let status : String?
    ...
    init(from decoder: Decoder) throws {
        ...
        result = try values.decodeIfPresent(ResCompProjectDt.self, forKey: .result)
...
struct ResCompProjectDt : Codable {
    let id : String?
    let user_id : String?
    let title : String?
    ...
    let user_details : Company_User_details?
    let user_request_images : [CompanyRequestImages]?
    let service_list : [Company_Service_list]?
    ...
    init(from decoder: Decoder) throws {
        ...
        no_of_worker = try values.decodeIfPresent(Int.self, forKey: .no_of_worker)
        ...
        user_details = try values.decodeIfPresent(Company_User_details.self, forKey: .user_details)
        user_request_images = try values.decodeIfPresent([CompanyRequestImages].self, forKey: .user_request_images)
        service_list = try values.decodeIfPresent([Company_Service_list].self, forKey: .service_list)
    }
}

struct Company_User_details : Codable {
    let id : String?
    let store_id : String?
...
struct Company_Service_list : Codable {
    let id : String?
    ...
    let status : String?
    let date_time : String?
    let total_assigned_worker : Int?
    let total_remaining_worker : Int?
    let assign_employee : [Company_Assign_employee]?
    ...
    enum CodingKeys: String, CodingKey {
        ...
        case status = "status"
        case date_time = "date_time"
        case total_assigned_worker = "total_assigned_worker"
        case total_remaining_worker = "total_remaining_worker"
    ...
    init(from decoder: Decoder) throws {
        ...
        status = try values.decodeIfPresent(String.self, forKey: .status)
        date_time = try values.decodeIfPresent(String.self, forKey: .date_time)
        total_assigned_worker = try values.decodeIfPresent(Int.self, forKey: .total_assigned_worker)
        total_remaining_worker = try values.decodeIfPresent(Int.self, forKey: .total_remaining_worker)
        assign_employee = try values.decodeIfPresent([Company_Assign_employee].self, forKey: .assign_employee)
    }

}
struct Company_Assign_employee : Codable {
    let id : String?
    let store_id : String?
    let first_name : String?
    let last_name : String?
    ...
    init(from decoder: Decoder) throws {
        ...
        discount = try values.decodeIfPresent(String.self, forKey: .discount)
        gST = try values.decodeIfPresent(String.self, forKey: .gST)
        number_type = try values.decodeIfPresent(String.self, forKey: .number_type)
        assign_id = try values.decodeIfPresent(String.self, forKey: .assign_id)
    }

}

struct CompanyRequestImages : Codable {
    let id : String?
    let request_id : String?
    let image : String?
    let date_time : String?
