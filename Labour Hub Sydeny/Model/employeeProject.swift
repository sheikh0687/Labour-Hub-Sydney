...
struct GetEmployeProject : Codable {
    let result : [ResEmployeeProject]?
    let message : String?
    let status : String?
    ...
    init(from decoder: Decoder) throws {
        ...
        result = try values.decodeIfPresent([ResEmployeeProject].self, forKey: .result)
...
struct ResEmployeeProject: Codable {
    let id : String?
    let user_id : String?
    let title : String?
    ...
    let user_details : Employe_details?
    let user_request_images : [Employee_request_images_Dt]?
    let service_list : [Employe_Service_list]?
    let my_service_list : My_service_list?
    ...
    enum CodingKeys: String, CodingKey {
        ...
        case my_service_list = "my_service_list"
    }
    ...
    init(from decoder: Decoder) throws {
        ...
        user_details = try values.decodeIfPresent(Employe_details.self, forKey: .user_details)
        user_request_images = try values.decodeIfPresent([Employee_request_images_Dt].self, forKey: .user_request_images)
        service_list = try values.decodeIfPresent([Employe_Service_list].self, forKey: .service_list)
        my_service_list = try values.decodeIfPresent(My_service_list.self, forKey: .my_service_list)
    }

}

struct My_service_list : Codable {
    let id : String?
...
struct Employe_Service_list : Codable {
    let id : String?
    let request_id : String?
    let cat_id : String?
    let cat_name : String?
...
struct Employe_details : Codable {
    let id : String?
    let store_id : String?
...
struct Employee_request_images_Dt : Codable {
    let id : String?
    let request_id : String?
    let image : String?
    let date_time : String?
